      ...
      >
        ...
        <div className="flex flex-col gap-3 items-center">
          <button
            ...
            className="flex items-center justify-center gap-3 w-48 py-3 rounded-xl border border-slate-200 dark:border-[#3a3a3a] bg-white dark:bg-[#1e1e1e] hover:bg-slate-50 dark:hover:bg-[#333] text-slate-700 dark:text-zinc-200 font-medium cursor-pointer transition-colors"
          >
