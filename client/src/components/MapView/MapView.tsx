...
export default function MapView({
  ...
  const showPopup = useCallback(
    (req: Request, hover = false) => {
      ...
      const hasCommented = !!(currentUserId && comments.some((com: any) => com.userId === currentUserId));
      ...
      const html = `
        <div class="popup-content" style="font-family:system-ui,sans-serif">
          ...
          <div style="display:flex;align-items:center;gap:12px;margin-top:8px;font-size:12px">
            ...
            <span style="display:flex;align-items:center;gap:4px${hasCommented ? ';color:#3b82f6;font-weight:600' : ''}" class="popup-metric">
              ${hasCommented
